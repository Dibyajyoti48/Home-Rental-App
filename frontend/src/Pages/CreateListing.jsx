      ...
      <div className="bg-gray-300 py-10 px-[20px] lg:px-[40px] pb-30">
        ...
        <form onSubmit={handleSubmit}>
          <div className="bg-white p-8 rounded-xl mt-10">
            ...
            {/* Type of place */}
            <h3 className="text-slate-700 text-lg mt-10 mb-5">
              What type of place will you offer?
            </h3>
            ...
            <div className='max-w-3xl'>
              <div className='mb-5'>
                ...
                <input type="text"
                 ...
                 name='streetAddress'
                 className='border border-gray-300 p-4 rounded-lg w-full text-lg font-semibold
                 focous:outline-none' 
            ...
            <div className='max-w-3xl grid grid-cols-1 md:grid-cols-2 gap-10'>
              <div className='mb-5'>
                <p className='font-bold mb-2'>Apartment (Optional)</p>
                <input type="text" 
            ...
            <div className='flex flex-wrap gap-10'>
              <div className='flex items-center gap-8 p-4 border border-gray-300 rounded-lg mb-5'>
                ...
                <div className='flex items-center gap-2 text-2xl'>
                  <MdRemoveCircleOutline className='cursor-pointer hover:text-red-500' onClick={() => guestCount > 1 && setGuestCount(guestCount - 1)} />
                  <p>{guestCount}</p>
                  <MdAddCircleOutline className='cursor-pointer hover:text-red-500' onClick={() => setGuestCount(guestCount + 1)} />
                </div>
              </div>
              <div className='flex items-center gap-8 p-4 border border-gray-300 rounded-lg mb-5'>
                <p className='font-semibold'>Bedrooms</p>
                <div className='flex items-center gap-2 text-2xl'>
                  <MdRemoveCircleOutline className='cursor-pointer hover:text-red-500' onClick={() => bedroomCount > 1 && setBedroomCount(bedroomCount - 1)} />
                  <p>{bedroomCount}</p>
                  <MdAddCircleOutline className='cursor-pointer hover:text-red-500' onClick={() => setBedroomCount(bedroomCount + 1)} />
                </div>
              </div>
              <div className="flex items-center gap-8 p-4 border border-gray-300 rounded-lg mb-5">
         ...
         <div className="flex flex-wrap gap-5">
          {facilities?.map((item,index) =>(
            <div className={`flex flex-col justify-center items-center w-52 h-24 border border-gray-300 rounded-lg cursor-pointer ${
         ...
         <DragDropContext onDragEnd={handleDragPhoto}>
                  ...
                  {photos.length >= 1 &&(
                    ...
                    {photos.map((photo,index) =>(
                      <Draggable key={index} draggableId={index.toString()} index={index}>
                        {(provided)=>(
                          <div className='relative w-64 h-36 cursor-move' 
                          ref={provided.innerRef}
                          {...provided.draggableProps}
                            {...provided.dragHandleProps}>
                              ...
                              <button type="button" onClick={()=>handleRemovePhoto(index)}
                                className='absolute ring-0 top-0 p-1 bg-white bg-opacity-80
          ...
          <h3 className="text-slate-700 text-lg my-10">
            ...
            <div className='flex flex-col'>
              ...
              name="title" 
              required 
              className='border border-gray-300 p-4 rounded-lg font-semibold w-full 
              sm:w-96'
              ...
              />
               ...
               <div className='flex items-center'>
                ...
                <input
                  ...
                  name="price"
                  required
                  className="border border-gray-300 p-4 rounded-lg font-semibold 
                  w-40"
          ...
          <button className='mt-10 bg-blue-800 text-white py-2 px-6 rounded-lg
          hover:shadow-2xl uppercase'>
