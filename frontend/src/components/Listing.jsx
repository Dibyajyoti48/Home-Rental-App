...
const Listing = () => {
    ...
    const getListings = async () => {
      try {
        const res = await fetch( selectedCategory !== "All" ? 
  ...
  return (
    <>
    <div className="px-20 py-12 md:px-5 flex justify-center flex-wrap 
    gap-14">
        {categories.map((category, index) =>  (
            <div className={`flex flex-col items-center text-slate-900 cursor-pointer`}
                key={index}
